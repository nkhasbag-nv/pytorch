...
"""
    ...
    @unittest.skipIf(IS_WINDOWS and SM89OrLater, "preferred_blas_library not supported on Windows")
...
"""
    ...
    @unittest.skipIf(IS_WINDOWS, "test relies on fork; Windows multiprocessing uses spawn")
...
print(value, end="")
    ...
    def test_device_memory_used(self):
        ...
        if IS_WINDOWS:
            ...
            self.assertGreaterEqual(b, a, "used memory should not decrease after allocation")
...
class TestMemPool(TestCase):
    ...
    @unittest.skipIf(IS_WINDOWS and SM89OrLater, "expandable_segments not supported (PYTORCH_C10_DRIVER_API_SUPPORTED not defined for windows builds)")

        ...
        try:
            ...
            if result is not None and result_numpy is not None:
                ...
                if sys.platform == "win32":
                    if array.tensor.numpy().dtype != _np.bool_ and result.tensor.numpy().dtype != result_numpy.dtype:
                        type_mismatch = True
                    
                    if array.tensor.numpy().dtype == _np.bool_ and result_numpy.dtype == _np.int32 and result.tensor.numpy().dtype != _np.int64:
